...
public class Entrepreneur_SignUp_Activity extends AppCompatActivity implements View.OnClickListener, onResult, VideoListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                LinkedInBuilder.getInstance(Entrepreneur_SignUp_Activity.this)
        ...
        Api_Calling.videoApiCalling(Entrepreneur_SignUp_Activity.this, getWindow().getDecorView().getRootView(), URLS.getSignUpVideo, videoJson(), videoListener);
...
//                finish();
                ...
                try {
                    alertBox(Entrepreneur_SignUp_Activity.this,jsonObject.getString("message"),i);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    public void onVideoResult(JSONObject jsonObject, Boolean status) {
        if (status && jsonObject != null) {
            ...
            if(Comman.getValueFromJsonObject(jsonObject1,"imagePath").equalsIgnoreCase(""))
            {
                ...
                Comman.setRectangleImage(Entrepreneur_SignUp_Activity.this,image,Comman.getValueFromJsonObject(jsonObject1,"imagePath"));
            }
