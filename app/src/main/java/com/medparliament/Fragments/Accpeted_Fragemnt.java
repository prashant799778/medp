...
public class Accpeted_Fragemnt extends Base_Fragement implements onResult{
    MySharedPrefrence m;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_accpeted__fragemnt, container, false);
    ...
    public JSONObject myPostJson()
    {
        ...
        try {
            jsonObject.put("userTypeId",""+m.getUserTypeId()).put("userId",""+m.getUserId()).put("status","1");
