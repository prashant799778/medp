...
public class Market_Insights_Fragments extends Base_Fragement implements onResult {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_market__insights__fragments, container, false);
        ...
        adapter=new MarketInsightsAdapter(getContext(),arrayList,m.getUserName(),1);
    ...
    public JSONObject myPostJson()
    {
        ...
        try {
            jsonObject.put("userTypeId",""+m.getUserTypeId()).put("userId",""+m.getUserId()).put("key",7);
        ...
        if(jsonObject!=null && status) {
            ...
            try {
                if (jsonObject.getJSONArray("result").length() > 0) {
                    ...
                    try {
                        ArrayList<Result> rm = gson.fromJson(jsonObject.getString("result"), new TypeToken<ArrayList<Result>>() {
                        }.getType());
                        arrayList.clear();
                        arrayList.addAll(rm);
