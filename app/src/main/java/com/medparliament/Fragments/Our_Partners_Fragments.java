...
public class Our_Partners_Fragments extends Base_Fragement implements onResult {
    MySharedPrefrence m;
    ImageButton bck;
    ImageView mainImg;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_our__partners__fragments, container, false);
    ...
    public JSONObject myPostJson() {
        ...
        try {
            jsonObject.put("userTypeId", "" + m.getUserTypeId()).put("userId", "" + m.getUserId()).put("key", 9);
    ...
    public void onResult(JSONObject jsonObject, Boolean status) {
        ...
        if (jsonObject != null && status) {
            ...
            try {
                ...
                ArrayList<DashboardGalleryModel> rm = gson.fromJson(jsonObject.getString("result"), new TypeToken<ArrayList<DashboardGalleryModel>>() {
                }.getType());
                gallerylsit.clear();
