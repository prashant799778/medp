...
public class Dashboard_market_adapter_new extends PagerAdapter {

    private Context context;
    ArrayList<NewModel> itemList;
    public Dashboard_market_adapter_new(Context context, ArrayList<NewModel> itemList, boolean flag) {
...
//        Comman.log("Market","Image"+pm.getImagePath());
