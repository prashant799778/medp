...
public class MedStreetAdapter extends RecyclerView.Adapter<MedStreetAdapter.NotificationHolder> {
    ArrayList<NewModel> list;
    Context context;
    int a;
    String userName;
    public MedStreetAdapter(Context context, ArrayList<NewModel>arrayList)
    {
    ...
    @NonNull
    @Override
    public MedStreetAdapter.NotificationHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater=LayoutInflater.from(context);
        View view=layoutInflater.inflate(R.layout.gallery_layout,parent,false);
        return new MedStreetAdapter.NotificationHolder(view);
    }
