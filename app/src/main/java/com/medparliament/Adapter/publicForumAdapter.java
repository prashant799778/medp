...
public class publicForumAdapter extends RecyclerView.Adapter<publicForumAdapter.NotificationHolder> {
    ArrayList<NewModel> list;
    Context context;
    int a;
    String userName;
    public publicForumAdapter(Context context, ArrayList<NewModel>arrayList)
    {
    ...
    @NonNull
    @Override
    public publicForumAdapter.NotificationHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater=LayoutInflater.from(context);
        View view=layoutInflater.inflate(R.layout.gallery_layout,parent,false);
        return new publicForumAdapter.NotificationHolder(view);
    }
