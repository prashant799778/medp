...
public class Dashboard_news_adapter_new  extends LoopingPagerAdapter<Dashboard_News_Model> {

    public Dashboard_news_adapter_new (Context context, ArrayList<Dashboard_News_Model> itemList, boolean isInfinite) {
