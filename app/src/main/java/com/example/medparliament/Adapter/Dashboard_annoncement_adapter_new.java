...
public class Dashboard_annoncement_adapter_new  extends LoopingPagerAdapter<DashboardAnnouncedModel> {

    public Dashboard_annoncement_adapter_new (Context context, ArrayList<DashboardAnnouncedModel> itemList, boolean isInfinite) {
