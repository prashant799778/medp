...
@Component({
  selector: 'app-edit-parter',
  templateUrl: './edit-parter.component.html',
  styleUrls: ['./edit-parter.component.css']
})
export class EditParterComponent implements OnInit {
  ...
  pageChanged(event){
    ...
    this.apiService.dataPostApi(data,AppSettings.getOurPartners).then((data: any[]) => {
