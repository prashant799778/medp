    ...
    try:
        ...
        if msg =="1":
            ...
            if userTypeId == 5:
                ...
                orderby="ab.id"
                column1="*"
                whereCondition1="and ab.userId='" + userId+ "'"
                data = databasefile.SelectQueryOrderby("userPost as ab",column1,WhereCondition1,"",startlimit,endlimit,orderby)
            ...
            if userTypeId == 6:
                ...
                if  data3:                     
                    ...
                    return commonfile.Errormessage()
            if userTypeId == 7:
                column="um.userName,um.email,cm.countryName,un.universityName,qm.qualificationName,"
